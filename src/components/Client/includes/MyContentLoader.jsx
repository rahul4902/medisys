...
const MyContentLoader = (props) => (
  <div className="container my-5">
    <div className="row bg-white rounded-20">
      <div className="col-md-6 col-12 py-3 px-2 rounded-20 h-25">
      ...
      <div className="col-md-6 d-none d-sm-block py-3 px-2 rounded-20 h-25">
        <ContentLoader viewBox="0 0 340 84" {...props}>
          <rect x="0" y="0" width="67" height="11" rx="3" />
          <rect x="76" y="0" width="140" height="11" rx="3" />
          <rect x="127" y="48" width="53" height="11" rx="3" />
