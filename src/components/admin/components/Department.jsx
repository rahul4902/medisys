...
function Department() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      var method;
      if (isEditFrom) {
        editUrl = "http://localhost:5000/admin/department/update/" + userId;
        method = "put";
      } else {
        editUrl = "http://localhost:5000/admin/department/create";
        method = "post";
      }
    ...
    <div className="row">
      <div className="col-lg-8 col-md-8 col-sm-12 col-12">
        <DynamicMuiTable
          ...
          data={departmentData}
          columns={columns}
          deleteUrl="http://localhost:5000/admin/department/delete"
          statusUrl="http://localhost:5000/admin/department/status"
          editDataUrl="http://localhost:5000/admin/department/getById"
